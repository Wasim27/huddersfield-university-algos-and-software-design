...
public interface ArrayGenerator<T> {
     ...
     *
     * @param size the size of the array to be generated.
     * @return an array of the specified size containing elements of the specified type.  No value may appear more than
     * once.
     *
     * @throws NegativeArraySizeException if the size given is negative.
     */
    T[] getNoDuplicatesArray(int size) throws NegativeArraySizeException, TooSmall;
}
